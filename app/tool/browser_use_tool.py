    ...
    async def _ensure_browser_initialized(self) -> BrowserContext:
        ...
        if self.browser is None:
            ...
            browser_config = BrowserConfig(
                headless=getattr(config.browser_config, "headless", True),
                disable_security=getattr(config.browser_config, "disable_security", True),
                extra_chromium_args=getattr(config.browser_config, "extra_chromium_args", []),
            )
